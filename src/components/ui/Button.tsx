...
const SIZE: Record<ButtonSize, string> = {
  ...
  // A field's height and corner: 44 on a phone, where it sits beside a 44px
  // field and under a thumb, and 40 from md, where fields, selects and dialog
  // buttons share one height and should read as one family.
  l: 'h-11 px-5 gap-2 text-100 md:h-10 md:rounded-md md:text-90',
};

const ICON_SIZE: Record<ButtonSize, string> = {
  s: 'h-7 w-7',
  m: 'h-8 w-8',
  l: 'h-11 w-11 md:h-10 md:w-10',
};
